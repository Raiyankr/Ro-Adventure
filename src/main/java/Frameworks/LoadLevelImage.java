...
public class LoadLevelImage {
    ...
    public static BufferedImage[] importImage() {
        ...
        assert  is != null && mc != null  && mm != null  && pi != null  && lf != null  && bt != null
                && sk != null && sb != null  && hb != null  && tp != null  && bb != null ;
        try {
            ...
            imageList[6] = ImageIO.read(sk);
            imageList[7] = ImageIO.read(sb);
            imageList[8] = ImageIO.read(hb);
            imageList[9] = ImageIO.read(tp);
            imageList[10] = ImageIO.read(bb);
